...
const config: ZkConnectClientConfig = {
  ...
  devMode: {
    ...
    devAddresses: ['0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266'],
...
function Providers() {
  ...
  useEffect(() => {
    ...
    if (!router.query.zkConnectResponse) {
      return;
    }
            ...
            <Center>
              <Flex mt={12} w="50vw" direction="column" mb={2} alignItems="center">
                ...
                <Text mt={1} color="gray.600">
                  You're one step away from being able participate in the community and reduce
                  cybercrime
                </Text>
                ...
                <Box mt={6}>
                  <Button
                    isLoading={
                      isAuthenticated === 0 && (hasBeenRedirected === 0 || hasBeenRedirected === 1)
                    }
                        ...
                        <SimpleGrid columns={12} spacing={3}>
                          ...
                          <GridItem colSpan={2} display="flex" justifyContent="flex-end">
                            <ButtonGroup size="sm" variant="outline">
                              <Button
                                colorScheme="green"
                                onClick={() => handleClaim(submission.url)}
                              >
                                Claim
                              </Button>
                              <Button
